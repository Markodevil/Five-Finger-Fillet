...
namespace SETS
{
    public class Sets : MonoBehaviour
    {
        ...
        public bool setImagePlayerOne = true;
        public bool setImagePlayerTwo = true;
        ...
        public Fingers GetCurrentFingure()
        {
            return RoundRequiredFingers[currentRound][currentFingureIndex];
        }
